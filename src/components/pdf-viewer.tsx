  ...
  return (
    <section className="surface-card overflow-hidden">
      ...
      <div className="bg-slate-100 p-2 sm:p-3">
        <iframe title={title} src={`${src}#view=FitH&toolbar=1`} className="h-[80dvh] min-h-[40rem] w-full rounded-xl border border-slate-200 bg-white shadow-inner" loading="lazy" />
      </div>
